...
Design only. No production code, no migration, no deployment. Resolves the naming/scoping decision flagged as blocking in [23_NEURA_BUSINESS_MESSAGING_MASTER_BUILD_PLAN.md](23_NEURA_BUSINESS_MESSAGING_MASTER_BUILD_PLAN.md) §3.
